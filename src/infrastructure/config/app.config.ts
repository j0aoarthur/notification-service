...
export const appConfig = registerAs('app', () => ({
  rabbitmq: {
    ...
    retryQueue: process.env['RABBITMQ_RETRY_QUEUE'] ?? 'notifications_retry_queue',
  ...
  email: {
    defaultFrom: process.env['MAIL_FROM'] || 'noreply@cooperativa.com',
    defaultFromName: process.env['MAIL_FROM_NAME'] || 'Sistema de Cooperativas',
